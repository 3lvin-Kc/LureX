...
const Campaigns = () => {
  ...
  const handleStartCampaign = async (campaignId: string) => {
    try {
      const success = await campaignService.startCampaign(campaignId);
      if (success) {
        toast({
          title: "Campaign started",
          description: "Emails are being sent to all targets in real time."
        });
      } else {
        toast({
          title: "Failed to start campaign",
          description: "There was an error starting the campaign.",
          variant: "destructive"
        });
      }
    } catch (error: any) {
