    ...
    <section className="relative pt-24 pb-20 md:pt-32 md:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 animate-fade-down">
            <span className="text-gradient">Strengthen</span> Your Team's 
            <span className="relative">
              <span className="text-gradient"> Defense</span>
              <svg className="absolute -bottom-2 w-full h-3 text-blue-400/30 dark:text-blue-700/30" viewBox="0 0 400 6" xmlns="http://www.w3.org/2000/svg">
